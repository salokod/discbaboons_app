...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(app)` | `/(drawer)` | `/(tabs)` | `/_sitemap` | `/about` | `/bag` | `/blog` | `/contact` | `/favourites` | `/forgotpass` | `/forgotuser` | `/login` | `/newDisc` | `/passwordreset` | `/register` | `/round` | `/settings`;
  type DynamicRoutes<T extends string> = `/blog/${SingleRoutePart<T>}`;
  type DynamicRouteTemplate = `/blog/[id]`;
